...
from apps.notifications.serializers.notification_serializers import NotificationReadOnlySerializer
from apps.notifications.serializers.notification_serializers import SubscriptionSerializer
